...
docker run -d --name kn05-bindmount -v C:\Users\lants\M347-Containerdienste\KN05\bind-mount:/mnt/scripts nginx:latest

# Skript im Container ausführen
docker exec kn05-bindmount bash /mnt/scripts/myscript.sh
```
...
Zeitstempel: 06/09/2026 09:37:00
Nachricht von Container 2 (kn05-vol2): Ich sehe den Inhalt!
Zeitstempel: 06/09/2026 09:37:01
```
